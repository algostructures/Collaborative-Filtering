...
/**
 * The BCFMSDSimilarity class represents an object, 
 * which uses weighted(BCF) User_Similarity and MSD_Similarity.
 * @author Saurabh
 */
public class BCFMSDSimilarity implements UserSimilarity {
     ...
     * @param long userId 
     * @param long userId
     * @return double similarity(100*User_Similarity+ MSDSimilarity)
     **/
    private double getSimilarity(long U, long V) throws TasteException{
        ...
        return 100*us.similarity(U, V)+ms.getSimilarity(U, V); 
    }
