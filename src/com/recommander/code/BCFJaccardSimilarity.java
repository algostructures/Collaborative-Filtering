 ...
 * @author Saurabh
 */
public class BCFJaccardSimilarity implements UserSimilarity {
     ...
     */
    BCFJaccardSimilarity(DataModel dm){
        this.dm = dm;
    }
     ...
     * @param long userId 
     * @param long userId
     * @return double similarity(Jaccard + User_Similarity)
     **/
    private double getSimilarity(long U, long V) throws TasteException{
        ...
        return us.similarity(U, V)+js.getSimilarity(U, V);
    }
